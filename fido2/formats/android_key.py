...
#ref https://medium.com/@herrjemand/webauthn-fido2-verifying-android-keystore-attestation-4a8835b33e9d
class AndroidKey(FormatBase):
    def __init__(self, attestation_object, authenticator_data):
        super().__init__(attestation_object, authenticator_data)
        self._SHA256_cose_identifier = -7
    ...
    def validateAttestation(self, clientDataHash):
        ...
        try:
            ...
            print(base64.b64encode(self._authenticator_data.getBinary()).decode('ascii'))
